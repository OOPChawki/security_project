 ...
 */
// (DONE) TODO CM01 - Add the missing annotations.
// (DONE) TODO CM02 - Do we need a mapped super class?  If so, which one?
@Entity
...
public class ClubMembership extends PojoBase implements Serializable {
	...
	// (DONE) TODO CM03 - Add annotations for M:1.  Changes to this class should cascade to StudentClub.
	@ManyToOne(cascade = CascadeType.ALL, fetch = FetchType.EAGER)
	@JoinColumn(name = "club_id", referencedColumnName = "club_id")
	private StudentClub club;

	// (DONE) TODO CM04 - Add annotations for 1:1.  Changes to this class should not cascade to MembershipCard.

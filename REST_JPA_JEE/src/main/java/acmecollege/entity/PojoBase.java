 ...
 */
// (DONE) TODO PB01 - Add annotation to define this class as superclass of all entities.  Please see Week 9 lecture slides.
@MappedSuperclass
// (DONE) TODO PB02 - Add annotation to place all JPA annotations on fields.
@Access(AccessType.FIELD) // NOTE:  By using this annotations, any annotation on a properties is ignored without warning
// (DONE) TODO PB03 - Add annotation for listener class.
@EntityListeners(PojoListener.class)
public abstract class PojoBase implements Serializable {
	private static final long serialVersionUID = 1L;

	// (DONE) TODO PB04 - Add missing annotations.
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(nullable = false, name = "id")
	protected int id;

	// (DONE) TODO PB05 - Add missing annotations.
	@Version
	protected int version;

	// (DONE) TODO PB06 - Add missing annotations (hint, is this column on DB?).
	@Basic(optional = false)
    @Column(name = "created")
	protected LocalDateTime created;

	// (DONE) TODO PB07 - Add missing annotations (hint, is this column on DB?).
	@Basic(optional = false)
    @Column(name = "updated")

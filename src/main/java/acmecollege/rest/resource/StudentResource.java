...
public class StudentResource {
    ...
    @GET
    @RolesAllowed({ADMIN_ROLE}) // R: Only a user with the SecurityRole ‘ADMIN_ROLE’ can get the list of all students.
    ...
    @GET
    @RolesAllowed({ADMIN_ROLE, USER_ROLE}) // R: A user with either the role ‘ADMIN_ROLE’ or ‘USER_ROLE’ can get a specific student.
    ...
    @POST
    @RolesAllowed({ADMIN_ROLE}) // R: Only a user with the SecurityRole ‘ADMIN_ROLE’ can add a new student.

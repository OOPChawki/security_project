...
// (DONE) TODO DS01 - This class is not an entity however it can be embedded in other entities.  Add missing annotation.
@Embeddable
public class DurationAndStatus implements Serializable {
	private static final long serialVersionUID = 1L;

	// (DONE) TODO DS02 - Add annotations
	@Basic(optional = false)
	@Column(name = "start_date", nullable = false)
	private LocalDateTime startDate;
	
	// (DONE) TODO DS03 - Add annotations
	@Basic(optional = false)
	@Column(name = "end_date", nullable = false)
	private LocalDateTime endDate;

	// (DONE) TODO DS04 - Add annotations
	@Basic(optional = false)
